...
export const Footer: React.FC<FooterProps> = ({ briBlue, nearestUnitName, }) => {
  return (
    <footer
      className={`${briBlue} text-white py-1 2xl:py-2 px-2 2xl:px-6 text-center text-sm font-semibold`}
    >
      <Marquee gradient={false} speed={50}>
        <div className="mx-8 whitespace-nowrap text-2xl 2xl:text-3xl tracking-widest">
