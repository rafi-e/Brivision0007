...
export const ExchangeRateTicker: React.FC<ExchangeRateTickerProps> = ({
  ...
  return (
    <section className={`p-4 bg-blue-900 border-t border-gray-300`}>
      <div className="w-full grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 xl:grid-cols-10 gap-2 text-xs text-center font-bold">
